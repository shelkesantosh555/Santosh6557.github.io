...
THREEx.DomEvents	= function(camera, domElement)
{
	...
	this._domElement.addEventListener( 'touchmove'	, this._$onMouseMove	, false );
	this._domElement.addEventListener( 'touchstart'	, this._$onClick	, false );
	this._domElement.addEventListener( 'touchend'	, this._$onMouseUp	, false );
...
THREEx.DomEvents.prototype.destroy	= function()
{
	...
	this._domElement.removeEventListener( 'touchstart'	, this._$onClick	, false );
